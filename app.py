...
def process_audio():
    ...
    try:
        ...
        if not spoken_text:
            ...
            return jsonify({
                "score": 70,
                "transcribed_text": "No se pudo transcribir el audio. Por favor, intente de nuevo.",
                "corrected_text": "",
                "error": "Sorry — we're experiencing a temporary technical issue. Please try again with a slightly shorter recording.",
